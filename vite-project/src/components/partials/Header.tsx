    ...
    <div className="px-4">
        <div className="flex items-center justify-between">
            <div className="flex shrink-0">
                ...
                <img className="w-16 h-auto" src="https://img.icons8.com/clouds/100/speech-bubble.png" alt="speech-bubble"/>
                    <p className="text-xl font-new font-bold text-gray-800">Posts</p>
                </a>
            </div>
